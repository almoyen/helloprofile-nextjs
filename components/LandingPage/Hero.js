            ...
            <div className="hero-header-container">
              ...
              <div className="hero-text-container">
                <div className="hero-text">
                  ...
                  personal, work and portfolio profile pages in minutes with
                  contactless technology to share your profile with anyone as
                  well as manage the contacts of people you meet.
                </div>
              </div>
            </div>
                ...
                <div className="w-col w-col-6 w-col-small-6 w-col-tiny-tiny-stack">
                  ...
                  >
                    <div className="request-invite-button">
                      <div className="button-text-white">Request Invite</div>
          ...
          <div className="hero-footer-container">
            ...
            <div className="hero-footer-text-container">
              <div className="text-footer-hero">
                ...
                <strong className="bold-text-3">HelloProfile</strong> for FREE!
              </div>
            </div>
          </div>
        </div>
